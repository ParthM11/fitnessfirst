...
$sqlFollowtype = "SELECT * from followuptype";
                        ...
                        <table id="table" class="table table-theme v-middle" data-plugin="bootstrapTable" data-toolbar="#toolbar" data-search="true" data-search-align="left" data-show-export="true" data-show-columns="true" data-detail-view="false" data-mobile-responsive="true" data-pagination="true" data-page-list="[10, 25, 50, 100, ALL]">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sortable="true" data-field="Category">Follow Up Term</th>
                                    <th data-sortable="true" data-field="description">description</th>
                                    <th>Action</th>
                                    <a href="followup-type-add.php" class="btn btn-primary">Add Category</a>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php
                                    while ($rowFollowtype = mysqli_fetch_assoc($resFollowtype)) {
                                    ?>

                                        <td><?= $rowFollowtype['fuptypeID'] ?></td>
                                        <td><?= $rowFollowtype['followType'] ?></td>
                                        <td><?= $rowFollowtype['desp'] ?></td>
                                        <td>
